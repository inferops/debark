...
reported by opening a private security advisory on this repository's GitHub
Security tab (Security -> Report a vulnerability accepts non-security
governance reports too), or by contacting one of the maintainers listed in
[GOVERNANCE.md](GOVERNANCE.md) directly through GitHub. debark does not yet
have a dedicated conduct mailing address; if one is created, it will be
published here and in GOVERNANCE.md. All complaints will be reviewed and
